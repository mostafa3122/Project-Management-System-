  ...
  return (
    <>
      ...
      <div className=" py-6 px-9 bg-gray-200 ">
        ...
        <div className="w-full bg-white rounded-lg shadow-[0px_4px_20px_0px_#0000000D] p-4 mt-6">
          {/* Desktop Table View */}
                ...
                >
                  ...
                  <div className="flex justify-between items-start pb-3 border-b border-gray-100 dark:border-slate-700 mb-3">
                    <div>
                      ...
                      <p className="text-[10px] text-gray-400 mt-0.5">ID: {project.id}</p>
                    </div>
                    {/* Actions in Header */}
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm text-[#4F4F4F] dark:text-gray-300">
                    <div className="flex flex-col">
                      ...
                      <span className="mt-1">
                        <span
                          className={`inline-block px-2.5 py-0.5 rounded-full text-xs font-medium ${(project.status ?? "").toLowerCase() === "active"
                    ...
                    <div className="flex flex-col">
                      <span className="text-[10px] uppercase text-gray-400 font-semibold tracking-wider">Users</span>
                      <span className="mt-1 font-medium text-gray-800 dark:text-white">
                        {Array.isArray(project.user) ? project.user.length : 0}
                      </span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-[10px] uppercase text-gray-400 font-semibold tracking-wider">Tasks</span>
                      <span className="mt-1 font-medium text-gray-800 dark:text-white">
                        {Array.isArray(project.task) ? project.task.length : 0}
                      </span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-[10px] uppercase text-gray-400 font-semibold tracking-wider">Date Created</span>
