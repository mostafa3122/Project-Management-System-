    ...
    <>
      <div className="bg-white flex justify-between items-center py-2 mb-6 font-montserrat">
        ...
        <button
          ...
          className="text-white bg-[#EF9B28] hover:bg-[#d98a20] px-6 py-3 rounded-full font-normal text-sm font-montserrat flex items-center gap-2 mx-6 transition-colors shadow-sm"
        >
