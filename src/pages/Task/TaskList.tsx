              ...
              tasksList.map((task, index) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm text-[#4F4F4F] dark:text-gray-300">
                    ...
                    <div className="flex flex-col">
                      <span className="text-[10px] uppercase text-gray-400 font-semibold tracking-wider">Assigned User</span>
                      <span className="mt-1 font-medium text-gray-800 dark:text-white">
                        {task?.employee?.userName || "Unassigned"}
                      </span>
                    </div>
                    <div className="flex flex-col col-span-2">
                      <span className="text-[10px] uppercase text-gray-400 font-semibold tracking-wider">Project</span>
                      <span className="mt-1 font-medium text-gray-800 dark:text-white">
                        {task?.project?.title || "N/A"}
                      </span>
                    </div>
                    <div className="flex flex-col col-span-2">
                      ...
                      <span className="mt-1 font-medium text-xs text-gray-800 dark:text-white">
                        {task.creationDate ? formatDate(task.creationDate) : "N/A"}
                      </span>
                    </div>
                  </div>
                </div>
